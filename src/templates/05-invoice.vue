<template>
  <div class="page">
    ...
    <div class="block" style="top: 78mm; font-size: 12px; line-height: 1.6;">
      <div>Invoice #: <span class="field">{{ invoiceNumber }}</span></div>
      <div>Date: <span class="field">{{ invoiceDate }}</span></div>
    ...
    <div class="block" style="top: 170mm; font-size: 12px;">
      <div class="heading" style="font-size: 12px; color: #1b1b1b;">
    ...
    <div class="block" style="top: 205mm; font-size: 11px;">
      <table class="table">
        <thead>
          <tr>
...
export default {
  ...
  props: {
    ...
    companyVat: { type: String, default: "" },
